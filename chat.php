<?php 
    ...
    $select = mysqli_query($conn, "SELECT * FROM users_form WHERE user_id = '$get_user_id'");
...
<body>
    <div class="container">
        <section class="chat-area">
            <header>
                <a href="home.php" class="back-icon"><img src="images/arrow-left-circle-fill.svg" alt=""></a>
            ...
            <div class="chat-box">
              <!-- <div class="text">
                <img src="uploaded_img/2151140105.jpg" alt="">
                <span>no message are available. once you send messagewill appear here.</span>
              </div> -->
              ...
              <img src="uploaded_img/person-bounding-box.svg" alt="">
                <div class="details">
                  <p><img src="uploaded_img/3840x1920.jpg" alt=""></p>
                </div>
              </div>
              <div class="chat outgoing">
                <div class="details">
                    <p><img src="uploaded_img/person-bounding-box.svg" alt=""></p>
                </div>
              </div> -->
            </div>
            <form action=""class="typing-area" method="POST">
                ...
                <button class="image"><img src="images/camera2 (1).svg" alt=""></button>
                <input type="file" name="send_image" accept="image/*" class="upload_img" hidden>
                <button class="send_btn" name="send_btn"><img src="images/send-check-fill.svg" alt=""></button>
            </form>
        </section>
    </div>
